// Algorithm: Expand point instances into screen-space marker quads and shade circular anti-aliased coverage.
// Time complexity: O(1) per vertex and fragment.
// Space complexity: O(1) local storage and fixed instance-buffer bandwidth.
struct VSUniforms {
